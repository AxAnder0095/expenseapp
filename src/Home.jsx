...
export const Home = () => {
    ...
    const getExpenseHistory = async () => {
        try {
            const collectionRef = await collection(db, 'users', auth?.currentUser?.uid, 'expense-history');
    ...
    const addExpense = async () => {
        try {
            ...
            const expenseHistoryCollection = await collection(db, 'users', auth?.currentUser?.uid, 'expense-history');
